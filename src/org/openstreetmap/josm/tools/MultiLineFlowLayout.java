...
/**
 * This is an extension of the flow layout that preferes wraping the text instead of increasing the component width when there is not enough
 * space.
 * <p>
 * This allows for a better preffered size computation. It should be used in all places where a flow layout fills the full width of the parent
 * container.
 * <p>
...
public class MultiLineFlowLayout extends FlowLayout {
    ...
    public String toString() {
        return "WrapingFlowLayout [align=" + getAlignment() + "]";
    }

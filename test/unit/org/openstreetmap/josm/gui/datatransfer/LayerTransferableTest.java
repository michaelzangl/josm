...
public class LayerTransferableTest {
     ...
     */
    @Test
    public void testTransferData() throws UnsupportedFlavorException, IOException {
        LayerTransferable transferable = new LayerTransferable(manager, Arrays.<Layer> asList(layer1, layer2));
    ...
    public void testTransferDataUnsupported() throws UnsupportedFlavorException, IOException {
        LayerTransferable transferable = new LayerTransferable(manager, Arrays.<Layer> asList(layer1, layer2));

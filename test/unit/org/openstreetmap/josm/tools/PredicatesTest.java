...
public class PredicatesTest {
    ...
    public void testEqualTo() {
        Integer testObject = new Integer(1);
        Predicate<Integer> equalTo = Predicates.equalTo(testObject);
        assertTrue(equalTo.evaluate(testObject));
        assertTrue(equalTo.evaluate(new Integer(1)));

        assertFalse(equalTo.evaluate(new Integer(2)));
    ...
    public void testIsNull() {
        ...
        assertFalse(isNull.evaluate(new Integer(2)));
    }
}
